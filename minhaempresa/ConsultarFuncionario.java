...
class ConsultarFuncionario {
    public void consultar() {
        ...
        try {
            ...
            if (conexao != null) {
                String sql = "SELECT f.id, f.nome, f.cargo, fa.nome_atributo, fa.valor_atributo " +
                             "FROM funcionarios f " +
                             "LEFT JOIN funcionario_atributos fa ON f.id = fa.funcionario_id " +
                             "ORDER BY f.id, fa.nome_atributo;";
